                                    ...
                                    <tbody>
                                        ...
                                        if(is_array($data)){
                                            foreach($data as $id => $unklabStudent){
                                                ...
                                                <a class='btn btn-danger px-1 py-0' href='delete.php?id={$unklabStudent['username']}'>DELETE</a>
                                                </td>
                                                </tr>";
                                            }
                                        }

                                        //function display_row($ArrayRows){
                                        //    // fungsi round last 3 digits
                                        //    echo"<tr class='text-center'>
                                        //    <td>{$ArrayRows['username']}</td>
                                        //    <td>{$ArrayRows['name']}</td>
                                        //    <td>{$ArrayRows['birthDate']}</td>
                                        //    <td>{$ArrayRows['residence']}</td>
                                        //    <td>{$ArrayRows['seating']}</td>
                                        //    <td>{$ArrayRows['seatingRow']}</td>
                                        //    <td>
                                        //    <a class='btn btn-primary px-3 py-0' href='edit.php?id={$ArrayRows['username']}'>EDIT</a>
                                        //    <a class='btn btn-danger px-1 py-0' href='delete.php'>DELETE</a>
                                        //    </td>
                                        //    </tr>";
                                        //}
//
                                        ...
                                        //        foreach($userID as $key => $unklabStudent) {
                                        //            print_r(sizeof($unklabStudent)); echo "<br /><br />";
        //
                                        //            if (sizeof($unklabStudent) == 6){
                                        //                foreach($unklabStudent as $key2 => $allStudent) {
                                        //                    // display data
                                        //                    display_row($allStudent);
                                        //                }
                                        //            }else{
                                        //               // display data
                                        //               display_row($allStudent);
